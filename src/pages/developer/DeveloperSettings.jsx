            ...
            <div className="flex items-center gap-5 mb-8">
              <div className="relative shrink-0">
                {currentUser.profilePic ? (
                  ...
                  <div className="w-20 h-20 rounded-2xl bg-linear-to-r from-cyan-500 to-blue-500 flex items-center justify-center text-white text-3xl font-bold ring-2 ring-white/20">
                    {currentUser.firstName?.charAt(0) || 'D'}
                  </div>
                )}
                {uploading && (
              ...
              <div className="flex-1 min-w-0">
                ...
                <span className="inline-block px-2 py-0.5 rounded-full text-xs bg-cyan-500/20 text-cyan-400 mb-3">Developer</span>
