...
//     if (!submitFile) {
//       setSubmitMsg('Please attach a file before submitting.')
//       errorToast('File attachment is required!')
//       return
//     }
...
//       const res = await fetch(`http://localhost:3000/developer/tasks/${submitTaskId}/submit`, {
//         method: 'PATCH',
//         headers: { Authorization: `Bearer ${token}` },
//         body: fd,
//       })
...
//                         {/* Start — stopPropagation prevents card navigation */}
//                         {task.status === 'assigned' && (
//                           <button
//                             onClick={e => { e.stopPropagation(); handleMarkInProgress(task._id) }}
...
//                                 {submitFile ? submitFile.name : 'Click to attach a file (required)'}
//                               </span>
//                               {submitFile && (
...
//                               disabled={submitting === task._id || !submitFile}
