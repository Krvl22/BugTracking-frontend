...
//       successToast('User reactivated successfully')
//       fetchUsers()
//     } catch (err) { errorToast('Failed to reactivate user'); console.error(err) }
//   }
...
//       {/* ✅ Reusable AdminSidebar */}
//       <AdminSidebar sidebarOpen={sidebarOpen} setSidebarOpen={setSidebarOpen} />

//       {/* ✅ Transparent scrollbar on main content */}
//       <div
...
//                 {filteredUsers.length} {filter === 'all' ? 'total' : filter} users — click row to view details
//               </p>
//             </div>
//           </div>
//           <div className="flex items-center space-x-3">
...
//                           className="px-3 py-1 bg-white/5 hover:bg-white/10 text-slate-400 rounded-lg text-xs transition-colors">
//                           Delete
//                         </button>
//                       </div>
//                     </td>
...
//                 className="flex-1 py-3 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-xl font-medium transition-all">
//                 Add User
//               </button>
